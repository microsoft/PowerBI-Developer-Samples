...
export const authorityUrl: string = "https://login.microsoftonline.de/common/";

// End point URL for Power BI API
export const powerBiApiUrl: string = "https://api.powerbi.de/";

// Scope for securing access token
export const scopeBase: string[] = ["https://analysis.cloudapi.de/powerbi/api/Report.Read.All"];