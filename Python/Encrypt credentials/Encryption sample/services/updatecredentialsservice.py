...
class UpdateCredentialsService:
    ...
    def update_datasource(self, access_token, cred_type, privacy_level, credentials_array, public_key, gateway_id, datasource_id):
    ...
    def make_update_datasource_patch_request(self, credentials_details_req, gateway_id, datasource_id, access_token):
        ...
        api_response = requests.patch(endpoint_url, data=json.dumps(
            credentials_details_req.__dict__), headers=self.headers)
